...
import com.itransition.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchNewsFragment : Fragment(R.layout.fragment_search_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //for delay in serch field before imediately geting results of search
        var job: Job? = null
        etSearch.addTextChangedListener { editable ->
            job?.cancel()
            // MainScope - couroutine dispatcher main
